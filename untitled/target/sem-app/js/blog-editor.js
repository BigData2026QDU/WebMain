...
(function() {
  ...
  class BlogEditor {
    ...
    buildChartSpec(tableName, columns) {
        ...
        .then(cols => {
          ...
          cols.forEach(col => {
            ...
            input.addEventListener('change', () => {
              ...
              block.content = this.buildChartSpec(block._table, block._columns);
    ...
    async saveReport() {
      ...
      const blocks = this.blocks
        .map(b => {
          if (b.type === 'chart') {
            const spec = this.buildChartSpec(b._table || '', b._columns || []);
